...
template<typename Type>
AVLTree<Type>::AVLTree():mRoot(NULL),mLength(0)
{
}

template<typename Type>
AVLTree<Type>::AVLTree(Type arr[],int nLength):mRoot(NULL),mLength(0)
{
...
template<typename Type>
bool AVLTree<Type>::insert(Type e,Node* &p)
{
    if( p== NULL)
    {
        p = new Node(e);
...
template<typename Type>
void AVLTree<Type>::rotateLeft(Node*& k2)
{
    Node* k1 = k2->left;
    k2->left = k1->right;
    k1->right = k2;
...
template<typename Type>
void AVLTree<Type>::rotateRight(Node* &k2)
{
    Node* k1 = k2->right;
    k2->right = k1->left;
    k1->left = k2;
...
template<typename Type>
void AVLTree<Type>::rotateLeftDouble(Node*& k3)
{
    rotateRight(k3->left);
    rotateLeft(k3);
}
...
template<typename Type>
void AVLTree<Type>::rotateRightDouble(Node*& k3)
{
    rotateLeft(k3->right);
    rotateRight(k3);
}
...
template<typename Type>
void AVLTree<Type>::traverse(Node* p)const
{
    if( p == NULL)
        return;
    else
...
template<typename Type>
void AVLTree<Type>::traverseByLevel(Node* root)const
{
    if(root == NULL)
    {
...
template<typename Type>
typename AVLTree<Type>::Node* & AVLTree<Type>::getParent(Node* p)
{  
    if( p == mRoot)  
        return NULL;  
    Node* ptr = mRoot;  
...
template<typename Type>
typename AVLTree<Type>::Node*& AVLTree<Type>::find(Type e)const
{  
    Node* ptr = mRoot;  
...
template<typename Type>
void AVLTree<Type>::clears(Node*& p)
{
    if( p == NULL )
        return;
    else
